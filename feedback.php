...
if(isset($_POST['submit']))
  {	
	...
	$sql="insert into feedback (sender, reciver, title,feedbackdata,attachment,classid) values (:user,:reciver,:title,:description,:attachment,:classid)";
    ...
    $query->execute(); 
	$msg="Feedback and Email Sent to " . $AdminEmail . " from ".$user ;
