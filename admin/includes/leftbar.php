	<nav class="ts-sidebar">
			...
			<li><a href="teamlist.php"><i class="fa fa-users"></i> TeamList</a>
			</li>
			<li><a href="ledger.php"><i class="fa fa-user"></i> &nbsp;Ledger</a>
			</li>
			...
			<li><a href="class.php"><i class="fa fa-user"></i> &nbsp;Class</a>
			</li>
			<li><a href="schoolyear.php"><i class="fa fa-user"></i> &nbsp;School Year</a>
			</li>
