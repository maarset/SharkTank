...
header('location:index.php');
	...
	{
		$SchoolYear_id = $_REQUEST['del'];
		$memstatus=0;
		$sql = "UPDATE SchoolYear SET status=:status WHERE  SchoolYearID =:aeid";
		$query = $dbh->prepare($sql);
		$query -> bindParam(':status',$memstatus, PDO::PARAM_STR);
		$query-> bindParam(':aeid',$SchoolYear_id, PDO::PARAM_STR);
		$query -> execute();
	...
	<div class="ts-main-content" >
		...
		<div class="content-wrapper">
			<div class="container-fluid">
				<div class="row">
					<div class="col-md-12">
						<div class="panel panel-default"><div class="panel-heading">List SchoolYear <a href="new-schoolyear.php?">New</a></div>
								...
								<?php if($error){?><div class="errorWrap" id="msgshow"><?php echo htmlentities($error); ?> </div><?php } 
									...
									<?php 
									$sqlL = "SELECT SY.SchoolYearID, SY.YearName,SY.StartDate,SY.EndDate,SY.Status, SY.CreatedBy,SY.CreatedDate,SY.UpdatedBy, SY.UpdatedDate from SchoolYear AS SY ";
									$sqlL .= "WHERE SY.Status = 1";
									...
									{				
										if ($SchoolYearIDGlobal == $result->SchoolYearID)
										{
										...
										<tr style="<?php echo($current); ?>">
											...
											<a href="edit-schoolyear.php?SchoolYearID=<?php echo $result->SchoolYearID;?>" onclick="return confirm('Do you want to Edit');">&nbsp; <i class="fa fa-pencil"></i></a>&nbsp;&nbsp;

											<a href="SchoolYear.php?del=<?php echo $result->SchoolYearID;?>" onclick="return confirm('Do you want to Delete');"><i class="fa fa-trash" style="color:red"></i></a>&nbsp;&nbsp;
