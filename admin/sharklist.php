...
header('location:index.php');
	...
	if(isset($_REQUEST['del']))
	{
		...
		$memstatus=0;
		$sql = "UPDATE Shark SET status=:status WHERE  SharkID =:aeid";
	...
	<div class="ts-main-content" >
		...
		<div class="content-wrapper">
			<div class="container-fluid">
				<div class="row">
					<div class="col-md-12">
						<div class="panel panel-default"><div class="panel-heading">List Sharks <a href="new-shark.php?">New</a></div>
								...
								<?php if($error){?><div class="errorWrap" id="msgshow"><?php echo htmlentities($error); ?> </div><?php } 
									...
									<?php 
									$sqlL = "SELECT S.SharkID,S.SharkName, S.email,C.ClassID, C.ClassName,C.Status,C.Room,SY.SchoolYearID,SY.YearName,SY.StartDate, ";
									$sqlL .= " SY.EndDate, S.CreatedBy,S.CreatedDate,S.UpdatedBy, S.UpdatedDate ";
									$sqlL .= " from  Shark AS S,Class C, SchoolYear AS SY ";
									$sqlL .= "WHERE S.ClassID = C.ClassID AND C.SchoolYearID = SY.SchoolYearID AND C.Status = 1 AND SY.Status = 1";
									...
									{				
										...
										<tr >
											...
											<a href="edit-shark.php?SharkID=<?php echo $result->SharkID;?>" onclick="return confirm('Do you want to Edit');">&nbsp; <i class="fa fa-pencil"></i></a>&nbsp;&nbsp;

											<a href="sharklist.php?del=<?php echo $result->SharkID;?>" onclick="return confirm('Do you want to Delete');"><i class="fa fa-trash" style="color:red"></i></a>&nbsp;&nbsp;
