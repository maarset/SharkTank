...
//echo("ClassIDGlobal=" . $ClassIDGlobal);
//echo("SchoolYearIDGlobal=" . $SchoolYearIDGlobal);
...
//echo("CurrentClassGlobal=" . $CurrentClassGlobal);
//echo("CurrentSchoolyearGlobal=" . $CurrentSchoolyearGlobal);
